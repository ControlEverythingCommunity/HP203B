...
public class HP203B
{
	public static void main(String args[]) throws Exception
	{
		...
		// Get I2C device, HP203B I2C address is 0x76(118)
		...
		double cTemp = (((data[0] & 0x0F) * 65536) + ((data[1] & 0xFF) * 256) + (data[2] & 0xFF)) / 100;
		double fTemp = (cTemp * 1.8) + 32;
		double pressure = (((data[3] & 0x0F) * 65536) + ((data[4] & 0xFF) * 256) + (data[5] & 0xFF)) / 100;
		...
		// Convert the data to 20-bits
		double altitude = (((data[0] & 0x0F) * 65536) + ((data[1] & 0xFF)* 256) + (data[2] & 0xFF)) / 100;
